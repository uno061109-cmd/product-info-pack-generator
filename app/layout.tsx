...
export const metadata: Metadata = {
  title: "留材库 Product Pack | 跨境商品资料包生成器",
  description:
    "留材库 Product Pack 为中国跨境电商卖家把 SKU 信息整理成英文 listing、QR 产品页、包装说明和可打印产品资料包。"
};
          ...
          <nav className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span>
                ...
                <span className="block text-xs text-slate-500">跨境商品资料包生成器</span>
              </span>
            </Link>
