...
export const metadata: Metadata = {
  title: "产品资料包生成器 | Product Info Pack Generator",
  description:
    "为中国跨境电商卖家把 SKU 信息整理成英文 listing、QR 产品页、包装说明和可打印产品资料包。"
};
      ...
      <body className="min-h-screen bg-mist text-ink antialiased">
        <header className="sticky top-0 z-40 border-b border-line bg-white/90 backdrop-blur">
          <nav className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <Link href="/" className="flex items-center gap-3">
              <img src="/images/pipg-logo.svg" alt="Product Info Pack Generator logo" className="h-11 w-11 rounded-lg shadow-soft" />
              <span>
                <span className="block text-base font-semibold text-ink">产品资料包生成器</span>
                <span className="block text-xs text-slate-500">Product Info Pack Generator</span>
              </span>
            </Link>
        ...
        <footer className="border-t border-line bg-white">
          <div className="mx-auto grid max-w-7xl gap-4 px-4 py-8 text-sm text-slate-500 sm:px-6 lg:px-8">
            <p>© 2026 产品资料包生成器 Product Info Pack Generator. Built for cross-border product documentation workflows.</p>
            <p>
